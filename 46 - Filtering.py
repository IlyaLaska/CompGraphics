...
im0 = Image.open('images/profile.jpg')
...
subplot(3,4,4)
im4 = im0.filter(ImageFilter.EDGE_ENHANCE)#LAPLASSIAN
plt.imshow(im4)
plt.title('Edge Enchanced')

subplot(3,4,5)
im5 = im0.filter(ImageFilter.EDGE_ENHANCE_MORE)
plt.imshow(im5)
plt.title('More Edge Enchanced')
